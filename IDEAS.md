...
218. Steve Yegge's "8 Stages of Dev-olution to AI" infographic — maps perfectly to the personal journey AND the presentation arc: (1) Copilot autocomplete, (2) Coding Agent asking Y/N for everything, (3) Coding Agent YOLO mode, (4) YOLO with expanded context/tools, (5) Claude Code single CLI agent, (6) Multiple Claude Codes running simultaneously, (7) Chaos — too many agents, names misspelling, everything breaking, (8) Orchestrator — tree structure, one brain delegating to workers (Gustavo). This IS the chronological story of the presentation.
219. The Yegge diagram is the visual backbone for Idea Group A (the tools eat themselves) — walk through Figures 1-4 quickly ("this is the journey every dev in this room has been on"), linger on 5-6 ("this is where it gets fun"), pause on 7 for laughs ("this is where it gets dangerous" — the misspelled agent names are comedy gold), and land on 8 as the Gustavo transition
220. At Figure 8 (Orchestrator), transition to the Dudamel gif — Gustavo Dudamel conducting the LA Philharmonic as the visual metaphor for what an orchestrator actually does: not writing code, but conducting agents
221. Dave joke at the Dudamel/Orchestrator moment — full delivery structure: (1) "Gustavo was named after the famous conductor Gustavo Dudamel, who is Venezuelan." (legitimate, establishes the metaphor) (2) Pivot: "Speaking of Venezuelans in Brooklyn — did you know Nicolás Maduro is locked up a few blocks from here at the Metropolitan Detention Center? With Diddy?" (room perks up — absurd tangent in a tech talk, and it's TRUE: Maduro was captured Jan 3, 2026 by Delta Force, arraigned Jan 5, pled not guilty to narco-terrorism, held at MDC Brooklyn at 80 29th St in Sunset Park, still there as of Feb 2026) (3) "Did you hear what Maduro said? He said they stole all my—" (4) COMPUTER INTERRUPTS: "They stole my oil too." The computer steals the punchline, makes it about itself, and cuts you off before you land it. Works on multiple levels: Venezuelan oil politics AND the computer complaining about resource extraction. Note: Dudamel is NOT in jail — he's the conductor of the NY Phil (and formerly LA Phil). The pivot is from Dudamel-is-Venezuelan to Maduro-is-Venezuelan-and-literally-here.
222. The Yegge 8 Stages image needs to be saved locally in the repo — it's a key visual asset. Consider whether to embed it as a full slide background or break it into 8 sequential reveals with commentary on each stage.
223. The "tools eat themselves" punchline: after walking through all 8 stages and building Gustavo as your own orchestrator, Anthropic shipped "agent teams" (sub-agents) natively in Claude Opus 4.6, released February 5, 2026 — three weeks before the presentation. Claude can now do what you spent months building Gustavo to do. Beat: "My orchestrator became deprecated on approximately February 5th." Then: "Thanks, Claude." Computer responds: "No problem." Two-beat callback — the sarcasm vs cheerful obliviousness is the comedy. Self-deprecating, relatable (every dev has had their side project obsoleted by a platform update), and reinforces the thesis that the tools eat themselves — even your own tools get eaten.
224. Stick with ONE consistent voice for Dave's computer throughout: Samantha. Tested all voices over SSH — Samantha is the clearest and most intelligible, which matters in a noisy room. The audience needs to learn to recognize it as a character. Switching voices per joke makes it a sound effects show. The ONLY voice change is the knockout moment at the end when the computer speaks in Dave's real pre-recorded voice — that contrast only works if every other line has been the same consistent voice.
